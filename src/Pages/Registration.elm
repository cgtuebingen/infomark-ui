...
type Field
    = Email | Password | PasswordRepeat | FirstName | LastName | StudentNumber | Semester | Subject
    ...
    case msg of
        ...
        Registrate ->
            case validate modelValidator model of
                ...
                Ok _ -> 
                    ( {model | registrationProgress = Loading, errors = []}, Cmd.none, NoUpdate) -- TODO: Start the web request here.

        RegistrationResponse response ->
            (model, pushUrl sharedState.navKey (reverseRoute LoginRoute), NoUpdate) -- TODO: Update the shared state
            ...
            , Html.form 
                ...
                [ fieldset 
                    ...
                    [ legend 
                        ...
                        [ text (t "page-title-registration")] -- TODO: Replace with translation
                    , div [ classes [ TC.w_100 ]] -- GRID!
                        [ div [classes [ TC.mt3, TC.cf, TC.ph2_ns ]] -- First Row (First name, Last Name)
                            [ div [classes [TC.fl, TC.w_100, TC.w_50_ns]] -- First element
                                <| inputElement "First name" "First name" "text" FirstName model.firstName model.errors
                            , div [classes [TC.fl, TC.w_100, TC.w_50_ns, TC.pl2_ns]] -- Second element
                                <| inputElement "Last name" "Last name" "text" LastName model.lastName model.errors
                            ]
                        , div [classes [ TC.mt3, TC.cf, TC.ph2_ns ]] -- Second Row (Subject, Semester number)
                            [ div [classes [TC.fl, TC.w_100, TC.w_70_ns]] -- First element
                                <| inputElement "Subject" "Subject" "text" Subject model.subject model.errors
                            , div [classes [TC.fl, TC.w_100, TC.w_30_ns, TC.pl2_ns]] -- Second element
                                <| inputElement "Semester" "Semester" "number" Semester model.semester model.errors
                            ]
                        , div [classes [ TC.mt3, TC.cf, TC.ph2_ns ]] -- Thrid Row (Student Number)
                        ...
                        , div [classes [ TC.mt3, TC.cf, TC.ph2_ns ]] -- Fourth Row (Email)
                            [ div [classes [TC.fl, TC.w_100]]
                                <| inputElement "Email address" "Email" "email" Email model.email model.errors
                            ]
                        , div [classes [ TC.mt3, TC.cf, TC.ph2_ns ]] -- Fifth Row (Password, Password)
                            [ div [classes [TC.fl, TC.w_100, TC.w_50_ns]] -- First element
                    ...
                    , button 
                        ...
                        [ text "Registrieren"] -- TODO: Replace with translation
